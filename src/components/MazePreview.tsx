      ...
      <div className="relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-lg p-5 overflow-hidden min-h-[550px] flex items-center justify-center">
        ...
        <div className="absolute top-32 left-1/2 transform -translate-x-1/2">
            ...
            boxShadow: '0 0 80px 20px rgba(0, 0, 0, 0.2)'
              ...
              <CardContent className="p-3 h-full">
                ...
                <div className="grid grid-cols-4 grid-rows-2 gap-2 h-full">
                  ...
                  <div className="col-span-2 row-span-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-xl relative overflow-hidden cursor-pointer transition-shadow duration-200 hover:shadow-sm" onClick={onImageUpload}>
                    {coverImage ?
                  // Show uploaded image
                  ...
                  <div className="col-span-1 row-span-1 rounded-xl overflow-hidden relative group cursor-pointer transition-shadow duration-200 hover:shadow-sm">
                    {(() => {
                  ...
                  <div className="col-span-2 row-span-1 rounded-xl overflow-hidden relative group cursor-pointer transition-shadow duration-200 hover:shadow-sm">
                    {(() => {
          ...
          <div className="absolute -bottom-32 left-1/2 transform -translate-x-1/2">
            <Button size="sm" variant="outline" onClick={refreshArticle} className="bg-background/80 backdrop-blur-sm border-border/50 text-label-large">
