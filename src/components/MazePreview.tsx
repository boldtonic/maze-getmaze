            ...
            boxShadow: '0 0 80px 20px rgba(0, 0, 0, 0.2)'
              ...
              <CardContent className="p-3 h-full">
                ...
                <div className="grid grid-cols-4 grid-rows-2 gap-2 h-full">
                  ...
                  <div className="col-span-2 row-span-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-xl relative overflow-hidden cursor-pointer transition-all duration-300" onClick={onImageUpload}>
                    {coverImage ?
                  // Show uploaded image
